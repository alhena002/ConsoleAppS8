...
namespace ConsoleAppS8
{
    ...
    partial void DeletePedidos(Pedidos instance);
		...
		public DataClasses1DataContext() : 
				base(global::ConsoleAppS8.Properties.Settings.Default.NeptunoConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class clientes : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _NombreCompa_ia;
    ...
    partial void OnNombreCompa_iaChanging(string value);
    partial void OnNombreCompa_iaChanged();
    ...
    partial void OnFaxChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[NombreCompa�ia]", Storage="_NombreCompa_ia", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		public string NombreCompa_ia
		{
			get
			{
				return this._NombreCompa_ia;
			}
			set
			{
				if ((this._NombreCompa_ia != value))
				{
					this.OnNombreCompa_iaChanging(value);
					this.SendPropertyChanging();
					this._NombreCompa_ia = value;
					this.SendPropertyChanged("NombreCompa_ia");
					this.OnNombreCompa_iaChanged();
				}
			}
		}
